...
plt.plot(
    -theta_annual.Zu, (rho * c_p * theta_area_int * subset_theta.dZ).cumsum() / 10**27
)
plt.xlabel("Depth (m)")
...
global_heat = (
    ...
    * c_p
    * (
        (theta_annual * theta_annual.dZ * theta_annual.dA)
        .sum("Z")
        .sum("latitude")
        .sum("longitude")
    )
)
global_heat_upper2000 = (
    rho
    * c_p
    * (
        (
            theta_annual.where(theta_annual.Zu > -2000)
            * theta_annual.dZ
            * theta_annual.dA
        )
        .sum("Z")
...
global_heat_upper700 = (
    rho
    * c_p
    * (
        (theta_annual.where(theta_annual.Zu > -700) * theta_annual.dZ * theta_annual.dA)
        .sum("Z")
        .sum("latitude")
        .sum("longitude")
    )
